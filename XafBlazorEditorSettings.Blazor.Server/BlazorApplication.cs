...
using XafBlazorEditorSettings.Blazor.Server.Services;

namespace XafBlazorEditorSettings.Blazor.Server {
    public partial class XafBlazorEditorSettingsBlazorApplication : BlazorApplication {
        public XafBlazorEditorSettingsBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafBlazorEditorSettingsBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
